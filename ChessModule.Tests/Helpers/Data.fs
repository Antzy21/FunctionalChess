        ...
        let PostWhiteKing() : game =
            {
                ...
                previousBoardOccurrences = Map[(BoardParser.fromFen "4k3/8/8/8/8/8/8/R4RK1", 1)];
                moves = ["0-0"]
            }
        let PostWhiteQueen() : game =
            {
                gameState = GameState.Create.fromFen "4k3/8/8/8/8/8/8/2KR3R b kq - 1 1";
                previousBoardOccurrences = Map[(BoardParser.fromFen "4k3/8/8/8/8/8/8/2KR3R", 1)];
                moves = ["0-0-0"]
            }
        let PostBlackKing() : game =
            {
                gameState = GameState.Create.fromFen "r4rk1/8/8/8/8/8/8/4K3 w KQ - 1 0";
                previousBoardOccurrences = Map[(BoardParser.fromFen "r4rk1/8/8/8/8/8/8/4K3", 1)];
                moves = ["0-0"]
            }
        let PostBlackQueen() : game =
            {
                gameState = GameState.Create.fromFen "2kr3r/8/8/8/8/8/8/4K3 w KQ - 1 0";
                previousBoardOccurrences = Map[(BoardParser.fromFen "2kr3r/8/8/8/8/8/8/4K3", 1)];
                moves = ["0-0-0"]
            }
        ...
        let getWhite1 () : game =
            {
                ...
                previousBoardOccurrences = Map[
                    (BoardParser.fromFen "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR", 1)
                ];
                moves = [
                    "e4";
                ]
        ...
        let getBlack1 () : game =
            {
                ...
                previousBoardOccurrences = Map[
                    (BoardParser.fromFen "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR", 1)
                    (BoardParser.fromFen "rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR", 1)
                ];
                moves = [
                    "d5";
                    "e4";
        ...
        let getWhite2 () : game =
            {
                ...
                previousBoardOccurrences = Map[
                    (BoardParser.fromFen "rnbqkbnr/pppppppp/8/8/4P3/8/PPPP1PPP/RNBQKBNR", 1);
                    (BoardParser.fromFen "rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR", 1);
                    (BoardParser.fromFen "rnbqkbnr/ppp1pppp/8/3P4/8/8/PPPP1PPP/RNBQKBNR", 1)
                ];
                moves = [
                    "exd5";
                    "d5";
        ...
        let getBlack2 () : game =
            {
                ...
                previousBoardOccurrences = Map[
                    ...
                    (BoardParser.fromFen "rnbqkbnr/ppp1pppp/8/3p4/4P3/8/PPPP1PPP/RNBQKBNR", 1);
                    (BoardParser.fromFen "rnbqkbnr/ppp1pppp/8/3P4/8/8/PPPP1PPP/RNBQKBNR", 1);
                    (BoardParser.fromFen "rnbqkb1r/ppp1pppp/5n2/3P4/8/8/PPPP1PPP/RNBQKBNR", 1)
                ];
                moves = [
                    "Nf6";
                    "exd5";
